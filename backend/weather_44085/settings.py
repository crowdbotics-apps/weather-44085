"""
Django settings for weather_44085 project.
...
ROOT_URLCONF = 'weather_44085.urls'
...
WSGI_APPLICATION = 'weather_44085.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weather_44085 API",
    "DESCRIPTION": "API documentation for weather_44085 App",
    "VERSION": "v1",
}
